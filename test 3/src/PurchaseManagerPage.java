...
public class PurchaseManagerPage extends javax.swing.JFrame implements ActionListener, MouseListener, WindowListener {
    ...
    public PurchaseManagerPage(User purchaseManager) {
        ...
        PurchaseManager myPurchaseManager = (PurchaseManager) purchaseManager;
    ...
    public void mousePressed(MouseEvent e) {
        if (e.getSource() == exitButton) {
            ...
            new ViewItem(null).setVisible(true);
            dispose();
        } else if(e.getSource() == jPanel7 ) {
            new DailyItemWiseSalesEntry(null).setVisible(true);
            dispose();
        } else if (e.getSource() == jPanel5) {
            new SalesReport(null).setVisible(true);
            dispose();
        } else if (e.getSource() == jPanel4) {
            new ViewPurchaseOrder(null).setVisible(true);
            //new ViewPurchaseOrder(PurchaseManager).setVisible(true);
            dispose();
        } else if (e.getSource() == jPanel8) {
            new StockLevelPage(null).setVisible(true);
            dispose();
        } else if (e.getSource() == jPanel6) {
            new CreateRequisitionPage(null).setVisible(true);
            dispose();
        }
